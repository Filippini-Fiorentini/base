...
\noindent The game can be represented by a bimatrix whose element $ij$ is the pair $(a_ij,b_ij)$, where $a_ij$ is the utility of player1 when he plays row $i$ and the other plays column $j$ (and the same for $b_ij$).
